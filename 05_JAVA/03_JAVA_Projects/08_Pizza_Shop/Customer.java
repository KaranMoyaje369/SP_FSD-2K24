...
public class Customer {
	...
	public static void main(String[] args) {
		...
		HashMap<Integer, PizzaShop> customer = new HashMap<Integer, PizzaShop>();
		int orderId = 1000;
		...
		while (true) {
			...
			case 3:
				...
				PizzaShop obj1 = customer.get(itemId2);
			...
			case 5:
				...
				Set<Entry<Integer, PizzaShop>> result = customer.entrySet();
